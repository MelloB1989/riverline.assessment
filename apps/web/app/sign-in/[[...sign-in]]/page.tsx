...
export default function SignInPage() {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-6 py-16">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(236,72,153,0.28),transparent_38%),radial-gradient(circle_at_0%_100%,rgba(168,85,247,0.14),transparent_34%)]" />
